...
func runCmd(ctx context.Context, args []string) error {
	...
	// Bind before opening the TUN device: if the port is taken, say so before touching anything else.
...
// refreshPeers reloads the tenant's peers from the control plane.
